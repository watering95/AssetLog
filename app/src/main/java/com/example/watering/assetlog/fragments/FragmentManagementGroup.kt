...
class FragmentManagementGroup : Fragment() {
    ...
    private fun initLayout() {
        ...
        val viewAdapter = RecyclerViewAdapterManagementGroup(lists)
        val recyclerView = mView.findViewById<RecyclerView>(R.id.recyclerview_fragment_management_group).apply {
