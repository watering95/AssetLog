...
class AppRepository(application: Application, scope:CoroutineScope) {
    ...
    fun getDairyForeignForDate(id_account: Int?, date: String?) = daoDairyForeign.getForDate(id_account, date)
    fun getIOForeignForDate(id_account: Int?, date: String?) = daoIOForeign.getForDate(id_account, date)
    ...
    fun sumOfInputInKRWUntilDate(id_account: Int?, date: String?) = daoIOKRW.sumOfInput(id_account, date)
    fun sumOfOutputInKRWUntilDate(id_account: Int?, date: String?) = daoIOKRW.sumOfOutput(id_account, date)
    fun sumOfInputInForeignUntilDate(id_account: Int?, date: String?, currency: Int?) = daoIOForeign.sumOfInput(id_account, date, currency)
    fun sumOfOutputInForeignUntilDate(id_account: Int?, date: String?, currency: Int?) = daoIOForeign.sumOfOutput(id_account, date, currency)
    fun sumOfInputKRWInForeignUntilDate(id_account: Int?, date: String?, currency: Int?) = daoIOForeign.sumOfInputKRW(id_account, date, currency)
    fun sumOfOutputKRWInForeignUntilDate(id_account: Int?, date: String?, currency: Int?) = daoIOForeign.sumOfOutputKRW(id_account, date, currency)
